...
const url = "https://zomatoliveapi.onrender.com/menuItem";
const pUrl = "https://zomapi-b2sk.onrender.com/placeOrder"
                ...
                <div className="container">
                    <div className="panel panel-primary">
                        ...
                        <div className="panel-body">
                            <form action="https://zomapi-b2sk.onrender.com/paynow" method='POST'>
                            <div className="row">
